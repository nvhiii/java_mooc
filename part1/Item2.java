// In this exercise, we create the classes Item, Suitcase and Hold to 
// practise the use of objects containing other objects.

// Item-class
// Create an Item class from which objects can be instantiated to 
// represent different items. The information to store is the name 
// and weight of the item (kg).
